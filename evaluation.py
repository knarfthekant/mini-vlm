...
from src.eval.lmms_eval_wrapper import NanoVLMWrapper
...
def cli_evaluate(args: Union[argparse.Namespace, None] = None) -> None:
    ...
    for args in args_list:
        try:
            ...
            if wandb_logger and args.wandb_args and not args.no_log_wandb:
                try:
    ...
    for args, results in zip(args_list, results_list):
        if results is not None:
            print(f"{args.model} ({args.model_args}), gen_kwargs: ({args.gen_kwargs}), limit: {args.limit}, num_fewshot: {args.num_fewshot}, "
